...
public class MusicOsgiTest {
    ...
    public static Option[] configuration() {
        ...
        return options(
                ...
                // Bundles under test
                mavenBundle("com.googlecode.refit", "refit").versionAsInProject(),
                mavenBundle("com.googlecode.refit", "refit-osgi").versionAsInProject(),
                mavenBundle("com.googlecode.refit.eg", "refit-eg-osgi-fixtures")
                        .versionAsInProject(),
                mavenBundle("com.googlecode.refit.eg", "refit-eg-osgi").versionAsInProject(),
